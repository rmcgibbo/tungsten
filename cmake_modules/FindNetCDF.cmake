...
file(TO_CMAKE_PATH "$ENV{NETCDF4_DIR}" _env_NETCDF4_DIR)
if(IS_DIRECTORY ${_env_NETCDF4_DIR})
    set(NetCDF_DIR "${_env_NETCDF4_DIR}" CACHE PATH "Path to search for NetCDF include and library files")
endif()
...
if ( NetCDF_LIBRARIES AND NetCDF_INCLUDE_DIRS )
    ...
    if ( NOT NetCDF_INCLUDE_DIR )
        message(SEND_ERROR "Can not locate NetCDF include directory. You may set the NETCDF4_DIR environment variable to provide a hint")
    endif()
